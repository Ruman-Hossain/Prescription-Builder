...
<?php
	...
	$query = $mysqli->query("insert into invoice values('', '$labDailySl', '$is_path', '$createNewId', '$refdId', '$coId', '$convertPN', '$sex', '$ageDetails', '$mobile', '$totalAmount', '$is_due', '0', '$date', '$time', '$deli_time', '$userFullName')") or die($mysqli->error);
	...
	if($query)
	{
		...
		if($invoiceType == 'new'){
			...
			if($discountAmount > 0)
			{
				$mysqli->query("insert into patient_discount values('', '$invoiceId', '$discountP', '$discountAmount', '0')");
			}
		...
		if($payment > 0){
			...
			if($invoiceType == 'new'){
				$mysqli->query("insert into patient_payment values('', '$invoiceId', '$payment', '$date', '0')");
			}else{
				$mysqli->query("insert into patient_due_payment values('', '$invoiceId', '$payment', '$date', '0')");
			}
		}
		if($invoiceType == 'new'){
			$mysqli->query("insert into refdfeeamount values('', '$invoiceId', '$refdId', '$coId', '$totalRefdFee', '0')");
		}else{
		...
		if(array_key_exists('dms1', $_COOKIE)){
			...
			$cookie = $_COOKIE['dms1'][$patientName][$mobile];
			foreach($cookie as $index => $array2){
				$query4 = $mysqli->query("insert into invoice_tests values('', '$invoiceId', '$array2[0]', '$array2[1]')");
			}
		}
		if($query4)
		{
                    	...
                    	<td colspan="5" style="padding-bottom:10px">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td align="center" valign="top"><font style="font-size:18px; font-weight:bold"><b>Riyadh Clinic & Diagnostic Centre</b></font><br />
                                    <font style="font-size:12px">Dhap, Jail Road, Rangpur.<br /></font></td>
                ...
                <div id="invoice_<?php echo $isl0; ?>">
                    	...
                    	<td colspan="5" style="padding-bottom:10px">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" width="100">&nbsp;</td>
                                    <td align="center" valign="top"><b>HI-TECH DIAGNOSTIC & CONSULTATION CENTRE</b></font><br />
                                    <font style="font-size:12px">Almi Bari, Dhap, Jail Road, Rangpur.<br />Mob: 01774402842</font></td>
                                    <td valign="top" align="center">
                                    <font style="font-size:16px; font-weight:bold">Cash Receipt</font><br />
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top" width="450px">
                                        <font style="font-size:18px; font-weight:bold"><b>HI-TECH DIAGNOSTIC & CONSULTATION CENTRE</b></font>
                                    </td>
