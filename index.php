            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><span style="color:#ea6d12;">Prescription Builder</span>
                                    <!--<img style="width:100%;" src="assets/img/race-logo.jpg" alt="Race Diagnostic Centre">-->
                                </div>
