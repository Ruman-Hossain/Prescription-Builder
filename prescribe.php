    ...
    <section class="wrapper">
        ...
        <div id="user_dialog" title="Add Data">
            <div class="form-group" style="height:50px;">
                ...
                <select name="medtype" id="medtype"  class="input-control" style="width:80%;float:right;">
            ...
            <div class="form-group" style="height:50px;">
                ...
                <select name="instruction" id="instruction" class="input-control" style="width:80%;float:right;">
            ...
            <div class="form-group" style="height:50px;">
                ...
                <select name="periodtype" id="periodtype" class="input-control" style="width:80%;float:right;">
                    <option value="Years">Years</option>
                    <option value="Months">Months</option>
                    <option value="Days" selected>Days</option>
